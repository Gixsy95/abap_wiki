...
DEFAULT_ALLOW_PREFIXES = ("ZABAPGIT", "ZEXAMPLE", "ZDEMO", "ZIF_ABAPGIT", "ZCL_ABAPGIT", "ZIF_APACK")
...
def scan_files(
    ...
    usable = [
        n for n in names
        if len(n) >= MIN_NAME_LEN and not n.upper().startswith(allow)
    ]
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--allow-prefix", action="append", default=[],
                        help="additional allowlisted name prefixes")
